...
public class ModbusMonitoringDeviceResource extends ServerResource  
{

	static Logger logger = LogManager.getLogger(ModbusMonitoringDeviceResource.class.getName());    
	...
	public Representation putMonitoringDevice(Representation representation) throws Exception {
		...
		ConfigurationManager confManager = ConfigurationManager.getInstance();
		MonitoringDeviceContainer monitoringDeviceCon = confManager.getMonitoringDeviceContainer();
		ModbusMonitoringDevice monitoringDev = monitoringDeviceCon.FromJSONModbus(jsonText);
		...
		if (monitoringDev == null) {
			...
			ModbusMonitoringDevice previousMDevice = (ModbusMonitoringDevice) monitoringDeviceCon.getObject(monitoringDev.getId());
