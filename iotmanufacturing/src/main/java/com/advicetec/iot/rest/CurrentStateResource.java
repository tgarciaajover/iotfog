...
public class CurrentStateResource extends ServerResource {
	...
	static final Logger logger = LogManager.getLogger(CurrentStateResource.class.getName());
	...
	/**
	 * Gets the current state registered for a measured entity.
	 * 
	 * @param representation  Optional JSON representation of the measured entity requested.
	 * 
	 * @return Current state representation in JSON in the measured entity.
	 * 
	...
	public Representation getEntityInterval(Representation representation) throws ResourceException, IOException{
		...
		try {
			...
			else
			{
				...
				JSONArray jsonArray = facade.getJsonCurrentState();
